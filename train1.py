...
print(predict('./train/0A6JM.png'))
print(predict('./train/JTtbn.png'))
print(predict('./train/LoORS.png'))
print(predict('./train/90WYy.png'))
print(predict('./train/nP59g.png'))
print(predict('./train/Ulg0R.png'))
